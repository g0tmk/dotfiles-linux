...
#
# by jonascj at https://github.com/jaor/xmobar/issues/239#issuecomment-233206552

fallback_width_px="8"

# select panel for trayer, stalonetray for stalonetray
tray_name="panel"
...
# If we fail to get trayer width, use a default size
if [ -z "$width" ]
then
